...
const Footer = () => {
  ...
  return (
    <div className="bg-black text-white w-full flex flex-col-reverse sm:flex-row  justify-between items-center py-10 mx-auto container sm:max-w-none px-2 sm:px-20 relative">
            ...
            <li key={index} className="list-none ">
              ...
              >
                <Image
                  ...
                  height={20}
                  alt={`icon ${index}`}
                  className="text-2xl group-hover:bg-orange-600"
                />
              </Link>
            </li>
          ))}
      ...
      <div className="flex items-center justify-between space-x-20 sm:space-x-40">
        <ul className="flex flex-col items-center space-y-3">
          <li className="hover:text-orange-400">Home</li>
          <li className="hover:text-orange-400">Pricing</li>
          <li className="hover:text-orange-400">products</li>
